...
| Shipped logging | Done | RedLogger hard dep; `NCZDGLog` ships to `r6\logs\mods\`. The dev instruments (`InkDebug.reds`, `MapWakeProbe.reds`) are deleted, not stripped-per-release |
